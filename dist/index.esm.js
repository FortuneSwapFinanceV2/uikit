...
import { ChainId } from '@fortuneswapfinance/sdk';
...
var links = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "Github",
                href: "https://github.com/FortuneSwapFinanceV2/",
                target: '_blank',
            },
            {
                label: "Docs",
                href: "https://FortuneSwapFinanceV2.gitbook.io/fortuneswap/",
            },
            {
                label: "Blog",
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#F6F6F7", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", 
    // inputBorder: "#cccccc",
    inputSecondary: "#cccccc", tertiary: "#EFF4F5", text: "#1B1464", textDisabled: "#BDC2C4", textSubtle: "#1B1464", activeButton: "#397f49", borderColor: "#E9EAEB", card: "#FFFFFF", nav: "#f9fdf9", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", 
    // inputBorder: "#cccccc",    
    inputSecondary: "#cccccc", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#c9c4d4", activeButton: "#397f49", borderColor: "#524B63", card: "#27262c", nav: "#27262c", gradients: {
